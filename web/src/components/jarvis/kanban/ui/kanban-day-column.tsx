...
const KanbanDayColumn = memo(function KanbanDayColumn({
  ...
  return (
    <section
      className={cn(
        "kanban-column flex h-full min-h-[400px] w-full flex-shrink-0 flex-col space-y-3 rounded-lg border bg-white/[0.02] backdrop-blur-sm transition-colors md:w-72",
    ...
    >
      <header className="sticky top-0 z-10 flex items-center justify-between border-b border-white/10 bg-[#0a0a0a]/80 p-2 backdrop-blur-sm">
      ...
      <div className="kanban-task-list min-h-[300px] flex-1 overflow-y-auto px-2 pb-2">
