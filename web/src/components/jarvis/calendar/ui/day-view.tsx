...
export default function DayView({
  ...
  return (
    <section className="space-y-6" aria-label="Visualização diária do calendário">
      <div className="bg-white/[0.02] backdrop-blur-sm rounded-lg border border-white/10 p-6 mt-2">
