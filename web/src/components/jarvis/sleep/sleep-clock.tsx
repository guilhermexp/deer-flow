...
export default function SleepClock({
  ...
  const [draggingHandle, setDraggingHandle] = useState<"bed" | "wake" | null>(
    null
  );
  ...
  const handleMouseDown = (handleType: "bed" | "wake") =>
